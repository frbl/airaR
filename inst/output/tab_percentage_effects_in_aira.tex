...
Person 1 & $\infty$ & $\infty$ & $\infty$ & $\infty$ & $\infty$ & $\infty$ \\ 
  Person 2 & $\infty$ & $\infty$ & $\infty$ & $\infty$ & -21327.08\% & $\infty$ \\ 
  Person 3 & $\infty$ & $\infty$ & $\infty$ & $\infty$ & $\infty$ & $\infty$ \\ 
  Person 4 & $\infty$ & $\infty$ & $\infty$ & $\infty$ & -712.91\% & $\infty$ \\ 
  Person 5 & $\infty$ & $\infty$ & -337.71\% & -191.36\% & $\infty$ & $\infty$ \\ 
   \bottomrule
\end{tabular}
