...
our_results <- round(our_results,1)
...
names(x) <- c("A $\\rightarrow$ D (aira)", "D $\\rightarrow$ A (aira)", "A $\\rightarrow$ D (Rosmalen 1)", "D $\\rightarrow$ A (Rosmalen 1)", "A $\\rightarrow$ D (Rosmalen 2)", "D $\\rightarrow$ A (Rosmalen 2)")
